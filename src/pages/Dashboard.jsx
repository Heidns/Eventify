  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-10">
        ...
        <Link to="/dashboard/create-event" className="btn-primary mt-4 sm:mt-0">
          ...
          {filteredEvents.map((event) => (
            <div key={event.id} className="glass rounded-2xl p-4 md:p-6 flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <Link to={`/dashboard/edit-event/${event.id}`} className="p-2 rounded-lg bg-surface-800 text-slate-400 hover:text-primary-400 hover:bg-surface-700 transition-all" title="Edit">
                  <RiEditLine />
                </Link>
                {event.status === 'draft' ? (
