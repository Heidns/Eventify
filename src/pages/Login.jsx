...
import { RiMailLine, RiLockLine, RiEyeLine, RiEyeOffLine, RiCalendarEventLine } from 'react-icons/ri';
  ...
  return (
    <div style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', minHeight: '100vh', display: 'flex', background: '#111827' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '48px 64px', maxWidth: '560px' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 700, color: '#fff', marginBottom: '8px' }}>Welcome back!</h1>
        <p style={{ color: '#9ca3af', fontSize: '15px', marginBottom: '36px' }}>Let's get you back to your events.</p>
